...
@section('container')
    <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Pre Marriage Healing</h1>
    <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
    <p>Kelas online berbasis web yang diperuntukkan khusus singlelillah yang ingin mempersiapkan diri menuju pernikahan bahagia dengan terbebas dari depresi, trauma dan tekanan masa lalu.</p>
