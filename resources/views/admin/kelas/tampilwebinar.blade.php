...
<div class="row">
    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <form action="/updatedatawebinar/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal" class="form-control" id="tanggal" value="{{ $data->tanggal->format('Y-m-d') }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="foto" class="form-label">Brosur</label>
                        <input type="file" name="foto" class="form-control" id="foto" aria-describedby="fotoHelp" value="{{ $data->foto }}">
                    </div>
