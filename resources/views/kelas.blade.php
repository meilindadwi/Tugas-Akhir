    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
                ...
                <p>Rumi Foundation Training menyediakan paket kelas online yang dapat Anda pilih sesuai kebutuhan.</p>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="pricing">
                        <div class="pricing-body">
                            ...
                            <p><a href="{{ $item->url }}" class="btn btn-outline-primary">Beli Paket</a></p>
                        </div>
                    </div>
                </div>
            @endforeach
